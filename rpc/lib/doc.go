...
* [Tendermint](https://github.com/Alex-duzhichao/tendermint/blob/master/rpc/core/routes.go)
* [tm-monitor](https://github.com/Alex-duzhichao/tendermint/blob/master/tools/tm-monitor/rpc.go)
*/
package rpc
